...
import { marcarNaoCompareceu } from '../../actions/agenda.actions'

export function NaoCompareceuButton({ agendamentoId, clienteNome }: { agendamentoId: string; clienteNome: string }) {
