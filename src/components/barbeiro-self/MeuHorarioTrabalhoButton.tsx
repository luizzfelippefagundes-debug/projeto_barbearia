...
import { Button, Modal, Select, WeekdaysPicker } from '../../components/ui'
import { atualizarMeuHorarioTrabalho } from '../../actions/barbeiroSelf.actions'
import { TIME_SLOTS } from '../../lib/dateUtils'

export function MeuHorarioTrabalhoButton({
  diasTrabalhoAtual,
  horaInicioAtual,
  horaFimAtual,
}: {
      ...
      <Modal open={open} onClose={fechar} title="Horário de trabalho" widthClassName="max-w-sm">
        <div className="flex flex-col gap-4">
          <p className="text-xs text-text-secondary">
            ...
            "bloquear horário" na sua agenda em vez de mudar isso aqui.
          </p>
