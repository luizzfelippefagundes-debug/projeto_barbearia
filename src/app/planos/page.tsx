...
import { FadeInSection } from '../../components/planos/FadeInSection'
...
const RECURSOS = [
  {
    ...
    descricao: 'Cada barbeiro vê o próprio dia, o dono vê a loja inteira. Bloqueia horário e sai mais cedo com um clique.',
  },
  {
    icon: MessageCircle,
  ...
  },
  {
    ...
    descricao: 'Assinatura do cliente é cobrada sozinha todo mês, com confirmação automática — sem cobrar por fora.',
  },
  {
    icon: Repeat,
  ...
  },
  {
    ...
    descricao: 'Fechamento de caixa, ticket médio e alerta de cliente sumindo — sem abrir planilha nenhuma.',
  },
  {
    icon: Gift,
  ...
  },
  {
    ...
    descricao: 'Controla o que vende no balcão (pomada, óleo) com alerta de estoque baixo, ligado direto na venda.',
  },
]
...
export default function PlanosPage() {
  return (
    <div className="min-h-screen scroll-smooth bg-bg">
      <PlanosHeader />
      ...
      <main>
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="mt-7 flex flex-col items-center justify-center gap-3 sm:mt-8 sm:flex-row lg:justify-start">
                  <a
                    ...
                    className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-accent bg-accent px-6 py-3 text-base font-semibold text-white shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-accent-hover hover:shadow-md sm:w-auto"
                  >
                  ...
                  <a
                    href="#planos"
                    className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-brass/40 bg-surface px-6 py-3 text-base font-semibold text-brass transition-all duration-200 hover:-translate-y-0.5 hover:bg-brass-muted sm:w-auto"
                  >
                    Ver planos e preços
                  </a>
                </div>
        ...
        {/* Recursos */}
        <FadeInSection>
          <section id="recursos" className="scroll-mt-16 border-y border-border bg-surface-raised py-16 sm:py-20">
            <div className="mx-auto max-w-6xl px-4 sm:px-6">
              <div className="mx-auto max-w-xl text-center">
                <h2 className="text-2xl text-text-primary sm:text-3xl">Tudo que a barbearia precisa</h2>
                <p className="mt-2 text-sm text-text-secondary sm:text-base">
                  Sem planilha, sem caderno, sem depender de ninguém lembrar de nada.
                </p>
              </div>
              <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-12 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3">
                {RECURSOS.map(({ icon: Icon, titulo, descricao }) => (
                  <div
                    key={titulo}
                    className="card flex flex-col gap-3 p-5 transition-all duration-200 hover:-translate-y-1 hover:shadow-md"
                  >
        ...
        {/* Planos */}
        <FadeInSection>
          <section id="planos" className="scroll-mt-16 px-4 py-16 sm:px-6 sm:py-20">
              ...
              <div className="mt-10 grid grid-cols-1 gap-5 sm:mt-12 lg:grid-cols-3">
                {PLANOS.map((plano) => (
                  <div
                    ...
                    className={
                      plano.destaque
                        ? 'card-raised relative flex flex-col gap-5 border-2 border-accent bg-surface p-6 transition-transform duration-200 hover:-translate-y-1 lg:-translate-y-2 lg:hover:-translate-y-3'
                        : 'card flex flex-col gap-5 bg-surface p-6 transition-transform duration-200 hover:-translate-y-1'
                    }
                  >
                    {plano.destaque && (
        ...
        {/* CTA final */}
        <FadeInSection>
          <section id="contato" className="scroll-mt-16 border-t border-border bg-surface-raised px-4 py-16 sm:px-6 sm:py-20">
            <div className="mx-auto flex max-w-2xl flex-col items-center gap-4 text-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-accent bg-accent px-6 py-3 text-base font-semibold text-white shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-accent-hover hover:shadow-md"
              >
                <MessageCircle size={18} aria-hidden="true" />
                Chamar no WhatsApp
              </a>
